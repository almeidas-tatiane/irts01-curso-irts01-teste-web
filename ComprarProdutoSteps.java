...
public class ComprarProdutoSteps {
	...
	public void estou_logado() {
		...
		loginPage.preencherEmail("tatiane.almeida@teste.com");
		loginPage.preencherPassword("tatiane");

		// Clicar no botao Sign In para logar
		loginPage.clicarBotaoSignIn();

		// Validar se o usuario esta logado de fato
		assertThat(homePage.estaLogado("Tatiane Almeida"), is(true));
	...
	@Quando("nome do produto na tela principal e na tela produto e {string}")
	public void nome_do_produto_na_tela_principal_e_na_tela_produto_e(String nomeProduto) {
	...
	@Quando("preco do produto na tela principal e na tela produto e {string}")
	public void preco_do_produto_na_tela_principal_e_na_tela_produto_e(String precoProduto) {
...
//						.endsWith("Product successfully added to your shopping cart"));
	...
	public void o_produto_aparece_na_confirmacao_com_o_nome_preco_tamanho_cor_e_quantidade(String nomeProduto, String precoProduto, String tamanhoProduto, String corProduto, Integer quantidadeProduto) {
